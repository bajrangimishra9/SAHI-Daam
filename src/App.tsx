...
import MaterialsPage from "@/pages/app/Materials";
import RequireAuth from "@/components/auth/RequireAuth";
import { AuthProvider } from "@/context/AuthContext";

/* ✅ Client Pages */
import ClientOrders from "@/pages/client/orders";
import UploadDrawing from "./pages/client/quantifycad/UploadDrawing";
import BillOfQuantities from "./pages/client/quantifycad/BillOfQuantities";
import AIProcurement from "./pages/client/quantifycad/AIProcurement";
import Settings from "./pages/client/quantifycad/Settings";
import { ProjectProvider } from "./pages/client/quantifycad/context/ProjectContext";
...
/* ✅ Admin Pages */
import AdminHome from "./pages/app/AdminDashboard";
