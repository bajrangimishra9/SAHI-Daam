...
const schema = z.object({
  ...
  grade_strength: z.string().trim().max(80).optional().or(z.literal("")),
  unit_base_price: z.coerce.number().min(0).max(10_000_000),
  monsoon_price_rise_pct: z.coerce.number().min(0).max(100),
  available_stock: z.coerce.number().min(0).max(1_000_000).optional(),
  delivery_sla: z.string().trim().max(80).optional().or(z.literal("")),
